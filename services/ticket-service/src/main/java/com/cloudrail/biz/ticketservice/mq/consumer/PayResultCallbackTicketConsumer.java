...
import com.cloudrail.biz.ticketservice.common.enums.SeatStatusEnum;
import com.cloudrail.biz.ticketservice.dao.entity.SeatDO;
import com.cloudrail.biz.ticketservice.dao.mapper.SeatMapper;
import com.cloudrail.biz.ticketservice.mq.domain.MessageWrapper;
import com.cloudrail.biz.ticketservice.mq.event.PayResultCallbackTicketEvent;
...
public class PayResultCallbackTicketConsumer implements RocketMQListener<MessageWrapper<PayResultCallbackTicketEvent>> {
    ...
    @Idempotent(
            uniqueKeyPrefix = "cloudrail-ticket:pay_result_callback:",
