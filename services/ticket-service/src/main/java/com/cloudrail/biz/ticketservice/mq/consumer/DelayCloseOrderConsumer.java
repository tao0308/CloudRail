...
package com.cloudrail.biz.ticketservice.mq.consumer;
...
import com.cloudrail.biz.ticketservice.common.constant.TicketRocketMQConstant;
...
import com.cloudrail.biz.ticketservice.mq.domain.MessageWrapper;
import com.cloudrail.biz.ticketservice.mq.event.DelayCloseOrderEvent;
...
public class DelayCloseOrderConsumer implements RocketMQListener<MessageWrapper<DelayCloseOrderEvent>> {
    ...
    @Idempotent(
            uniqueKeyPrefix = "cloudrail-ticket:delay_close_order:",
