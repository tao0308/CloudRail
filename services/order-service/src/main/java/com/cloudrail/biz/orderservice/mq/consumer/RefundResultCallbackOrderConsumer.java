...
package com.cloudrail.biz.orderservice.mq.consumer;

import lombok.RequiredArgsConstructor;
import lombok.extern.slf4j.Slf4j;
import org.apache.rocketmq.spring.annotation.RocketMQMessageListener;
import org.apache.rocketmq.spring.core.RocketMQListener;
import com.cloudrail.biz.orderservice.common.constant.OrderRocketMQConstant;
...
import com.cloudrail.biz.orderservice.dto.domain.OrderItemStatusReversalDTO;
import com.cloudrail.biz.orderservice.dto.resp.TicketOrderPassengerDetailRespDTO;
import com.cloudrail.biz.orderservice.mq.domain.MessageWrapper;
import com.cloudrail.biz.orderservice.mq.event.RefundResultCallbackOrderEvent;
...
public class RefundResultCallbackOrderConsumer implements RocketMQListener<MessageWrapper<RefundResultCallbackOrderEvent>> {
    ...
    @Idempotent(
            uniqueKeyPrefix = "cloudrail-order:refund_result_callback:",
