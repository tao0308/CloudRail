...
package com.cloudrail.biz.orderservice.service.impl;
...
import com.cloudrail.biz.orderservice.common.enums.OrderCanalErrorCodeEnum;
import com.cloudrail.biz.orderservice.common.enums.OrderItemStatusEnum;
import com.cloudrail.biz.orderservice.common.enums.OrderStatusEnum;
import com.cloudrail.biz.orderservice.dao.entity.OrderDO;
import com.cloudrail.biz.orderservice.dao.entity.OrderItemDO;
import com.cloudrail.biz.orderservice.dao.entity.OrderItemPassengerDO;
import com.cloudrail.biz.orderservice.dao.mapper.OrderItemMapper;
import com.cloudrail.biz.orderservice.dao.mapper.OrderMapper;
import com.cloudrail.biz.orderservice.dto.domain.OrderStatusReversalDTO;
import com.cloudrail.biz.orderservice.dto.req.CancelTicketOrderReqDTO;
import com.cloudrail.biz.orderservice.dto.req.TicketOrderCreateReqDTO;
import com.cloudrail.biz.orderservice.dto.req.TicketOrderItemCreateReqDTO;
import com.cloudrail.biz.orderservice.dto.req.TicketOrderPageQueryReqDTO;
import com.cloudrail.biz.orderservice.dto.req.TicketOrderSelfPageQueryReqDTO;
import com.cloudrail.biz.orderservice.dto.resp.TicketOrderDetailRespDTO;
import com.cloudrail.biz.orderservice.dto.resp.TicketOrderDetailSelfRespDTO;
import com.cloudrail.biz.orderservice.dto.resp.TicketOrderPassengerDetailRespDTO;
import com.cloudrail.biz.orderservice.mq.event.DelayCloseOrderEvent;
import com.cloudrail.biz.orderservice.mq.event.PayResultCallbackOrderEvent;
import com.cloudrail.biz.orderservice.mq.produce.DelayCloseOrderSendProduce;
import com.cloudrail.biz.orderservice.remote.UserRemoteService;
import com.cloudrail.biz.orderservice.remote.dto.UserQueryActualRespDTO;
import com.cloudrail.biz.orderservice.service.OrderItemService;
import com.cloudrail.biz.orderservice.service.OrderPassengerRelationService;
import com.cloudrail.biz.orderservice.service.OrderService;
import com.cloudrail.biz.orderservice.service.orderid.OrderIdGeneratorManager;
...
import com.cloudrail.framework.starter.convention.page.PageResponse;
import com.cloudrail.framework.starter.convention.result.Result;
import com.cloudrail.framework.starter.database.toolkit.PageUtil;
