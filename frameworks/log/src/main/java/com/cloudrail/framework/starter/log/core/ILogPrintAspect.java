...
package com.cloudrail.framework.starter.log.core;
...
public class ILogPrintAspect {
     ...
     * 打印类或方法上的 {@link ILog}
     */
    @Around("@within(com.cloudrail.framework.starter.log.annotation.ILog) || @annotation(com.cloudrail.framework.starter.log.annotation.ILog)")
